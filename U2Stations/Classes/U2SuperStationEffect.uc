 ...
 */
//-----------------------------------------------------------
// U2SSupertationEffect.uc
// Base particle effect for all big stations. Recreated from U2XMP.
// GreatEmerald, 2010
//-----------------------------------------------------------
class U2SuperStationEffect extends Emitter;
...
DefaultProperties
{
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter1
        ...
        MaxParticles=1
        Name="SpriteEmitter1"
        StartLocationRange=(X=(Min=35.000000,Max=35.000000),Z=(Min=-10.000000,Max=-10.000000))
