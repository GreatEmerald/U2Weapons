 ...
 */
//-----------------------------------------------------------
// U2PickupAutoTurret.uc
// A pickup for the Automated Turret
// 2009, GreatEmerald
//-----------------------------------------------------------
class U2PickupAutoTurret extends UTWeaponPickup;
...
defaultproperties
{
     ...
     PickupMessage="You got an Auto Turret."
     PickupSound=Sound'U2XMPA.AutoTurret.AutoTurretPickup'
     DrawType=DT_StaticMesh
     StaticMesh=StaticMesh'U2Turrets.Turrets.AutoTurret'
     DrawScale=0.700000
