...
//How to count damage:
//1 - DamageType.ArmorHealthRatio = Multiplier; (get a multiplier which we'll use for getting a smaller than needed damage number)
//Multiplier * OriginalDamage = SmallDamage; (multiply the original damage and voila)
//(OriginalDamage - SmallDamage) / 10 + SmallDamage = FinalDamage. (use this huge formula that adds 10% from the shield damage to the usual damage)
//Keep in mind that in U2, EVERYTHING has protection from one damage type or another. Including players.

var() config string ReplacedWeaponClassNames0; //To hell with PlayInfo not supporting arrays!
...
event PreBeginPlay()
{
      ...
      /*if (FirePowerMode == 1) { //Original XMP - use the UTXMP original values
        ...
        /*Class'U2Weapons.U2AssaultRifleFire'.default.DamageMin = 12;
        Class'U2Weapons.U2AssaultRifleFire'.default.DamageMax = 12;
        Class'U2Weapons.U2AssaultRifleProjAlt'.default.Damage = 80;
        Class'U2Weapons.U2ProjectileASExplAlt'.default.Damage = 20.0;
        Class'U2Weapons.U2ProjectileAltEnergyRifle'.default.Damage = 180.0;
        Class'U2Weapons.U2ProjectileEnergyRifle'.default.Damage = 10.0;
        Class'U2Weapons.U2FireFlameThrower'.default.DamageMin = 15;
        Class'U2Weapons.U2FireFlameThrower'.default.DamageMax = 15;
        Class'U2Weapons.U2ProjectileAltFlameThrower'.default.Damage = 5.0;
        Class'U2Weapons.U2ProjectileFragGrenade'.default.Damage = 200.0;
        Class'U2Weapons.U2ProjectileIncendiaryGrenade'.default.Damage = 5.0;
        Class'U2Weapons.U2ProjectileConcussionGrenade'.default.Damage = 15.0;
        Class'U2Weapons.U2ProjectileRocketDrunken'.default.Damage = 70.0;
        Class'U2Weapons.U2ProjectileRocketSeeking'.default.Damage = 70.0;
        Class'U2Weapons.U2ProjectileRocket'.default.Damage = 200.0;
        Class'U2Weapons.U2ProjectileAltShotgun'.default.Damage = 22.0;
        Class'U2Weapons.U2FireShotgun'.default.DamageMin = 16;
        Class'U2Weapons.U2FireShotgun'.default.DamageMax = 16;
        Class'U2Weapons.U2FireSniper'.default.DamageMin = 80;
        Class'U2Weapons.U2FireSniper'.default.DamageMax = 80;
        Class'U2Weapons.U2FirePistol'.default.DamageMin = 60;
        Class'U2Weapons.U2FirePistol'.default.DamageMax = 60;
        Class'U2Weapons.U2FireAltPistol'.default.DamageMin = 120;
        Class'U2Weapons.U2FireAltPistol'.default.DamageMax = 120;
        Class'U2Weapons.U2ProjectileEMPGrenade'.default.Damage = 200.0;
        Class'U2Weapons.U2ProjectileToxicGrenade'.default.Damage = 100.0;
        Class'U2Weapons.U2HurterProxy_Gas'.default.myDamage = 30.0;
        Class'U2Weapons.U2HurterProxy_Fire'.default.myDamage = 80.0;*/
      ...
      /*else if (FirePowerMode == 3) { //Dampened XMP
        Class'U2Weapons.U2AssaultRifleFire'.default.DamageMin = 11;
        Class'U2Weapons.U2AssaultRifleFire'.default.DamageMax = 11;
        Class'U2Weapons.U2AssaultRifleProjAlt'.default.Damage = 96.25;
        Class'U2Weapons.U2ProjectileASExplAlt'.default.Damage = 35.0;
        Class'U2Weapons.U2ProjectileAltEnergyRifle'.default.Damage = 22.8;
        Class'U2Weapons.U2ProjectileEnergyRifle'.default.Damage = 7.0;
        Class'U2Weapons.U2FireFlameThrower'.default.DamageMin = 10;
        Class'U2Weapons.U2FireFlameThrower'.default.DamageMax = 11;
        Class'U2Weapons.U2ProjectileIncendiaryGrenade'.default.Damage = 27.50;
        Class'U2Weapons.U2ProjectileRocketDrunken'.default.Damage = 38.5;
        Class'U2Weapons.U2ProjectileRocketSeeking'.default.Damage = 38.5;
        Class'U2Weapons.U2ProjectileRocket'.default.Damage = 104.5;
        Class'U2Weapons.U2FireSniper'.default.DamageMin = 65;
        Class'U2Weapons.U2FireSniper'.default.DamageMax = 65;
        Class'U2Weapons.U2FirePistol'.default.DamageMin = 31;
        Class'U2Weapons.U2FirePistol'.default.DamageMax = 31;
        Class'U2Weapons.U2FireAltPistol'.default.DamageMin = 50;
        Class'U2Weapons.U2FireAltPistol'.default.DamageMax = 50;
        Class'U2Weapons.U2ProjectileEMPGrenade'.default.Damage = 15.0;
      ...
      /*for (x = 0; x < 12; x++ ) //TODO - and don't forget X
      {
          Weapons = class<Weapon>(DynamicLoadObject(GetPropertyText("ReplacedWeaponClassNames"$x),class'Class'));
          if (Weapons.IsA('Redeemer') || Weapons.IsA('Painter'))
              U2WeaponClasses[x].default.FireModeClass[0].default.AmmoClass.default.InitialAmount =
              U2WeaponClasses[x].default.FireModeClass[0].default.AmmoClass.default.MaxAmmo;
      }  */
}
